...
Current architecture and implementation principles are defined in [`docs/MIKI_AI_18_DOMAIN_DESIGN_PHILOSOPHY.txt`](docs/MIKI_AI_18_DOMAIN_DESIGN_PHILOSOPHY.txt).
Version-by-version work directives and implementation-history files are not canonical design sources.
