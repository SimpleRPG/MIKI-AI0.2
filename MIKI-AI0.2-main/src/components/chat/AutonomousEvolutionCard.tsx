...
import { mikiSelfCodingSuperchargerService, SelfCodingMutationTestResult } from '../../miki/selfDevelopment/services/mikiSelfCodingSuperchargerService';
...
export const AutonomousEvolutionCard: React.FC<AutonomousEvolutionCardProps> = ({
  ...
  const [mutationResult, setMutationResult] = useState<SelfCodingMutationTestResult | null>(
