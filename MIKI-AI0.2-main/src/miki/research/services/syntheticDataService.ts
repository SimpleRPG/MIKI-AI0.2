...
import { toolsService } from '../../capability/services/toolsService';
        ...
        try {
          ...
          if (isNativeReady || isWebReady) {
            ...
            const stream = isNativeReady
              ? deterministicRuntimeService.streamDeterministicChat(messages, { temperature: 0.5, max_tokens: 256 })
              : deterministicRuntimeService.streamChat(messages, { temperature: 0.5, max_tokens: 256 });
