...
import { sendChatMessage, apiUrl, getCustomApiHeaders, SERVER_UNAVAILABLE_MESSAGE } from '../../../services/api';
...
export class TeacherRequestService {
  ...
  public async requestTeacherMaterial(
    ...
    try {
      ...
      const evidenceId = evidenceIdentityService.create('teacher', `${payload.failureCategory}|${mat.category || ''}|${Date.now()}`);
