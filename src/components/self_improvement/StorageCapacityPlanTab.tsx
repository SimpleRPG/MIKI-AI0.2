      ...
      <div className="p-4 rounded-xl bg-gradient-to-br from-cyan-950/40 via-slate-900 to-slate-950 border border-cyan-500/40 space-y-3">
        ...
        <div className="flex items-center justify-between pt-2">
          ...
          >
            ...
            <span>{isCleaning ? 'クリーンアップ実行中...' : '重複排除 ＆ 自動整理実行'}</span>
          </button>
      ...
      <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800 space-y-3">
        <div className="flex items-center justify-between">
          <span className="text-xs font-bold text-slate-200 flex items-center gap-2">
            ...
            <span>自動整理・監査ログ (最近10件)</span>
          </span>
          <span className="text-[10px] text-slate-500">SHA-256重複チェック</span>
        </div>
