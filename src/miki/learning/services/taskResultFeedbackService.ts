import { ExecutionEvent, executionEventBusService } from '../../execution/services/executionEventBusService';
import { planOrchestratorService } from '../../strategy/services/planOrchestratorService';
import { taskExecutionOrchestratorService } from '../../execution/services/taskExecutionOrchestratorService';
...
export class TaskResultFeedbackService {
  ...
  private onEvent(event: ExecutionEvent): void {
    ...
    const result = planOrchestratorService.applyExecutionEventResult({
      ...
      environment: event.environment as import('../../execution/services/executionRunnerService').ExecutionEnvironment,
