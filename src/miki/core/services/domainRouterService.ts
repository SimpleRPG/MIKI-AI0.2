...
export type DomainCommand =
  ...
  | 'RUN_SELF_IMPROVEMENT' | 'SAVE_AUTONOMY_CONFIG' | 'GENERATE_CANDIDATE' | 'APPROVE_REVIEWED_CANDIDATE' | 'ADOPT_REVIEWED_CANDIDATE' | 'CREATE_REVIEW_PACKAGE' | 'PLAN_PENDING_IMPROVEMENT_RUN' | 'RESOLVE_CAPABILITY_GAPS' | 'DISCOVER_IMPROVEMENT_ISSUE' | 'LEARN_FROM_CORE_RESULT' | 'GET_STATUS' | 'FLUSH' | 'VALIDATE_CANDIDATE' | 'ASSESS_DOMAIN' | 'PARTICIPATE' | 'VERIFY_CONNECTION';
