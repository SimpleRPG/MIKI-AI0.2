...
const bridge=read('miki/selfAwareness/services/cognitiveEvidenceIntegrationService.ts');
...
const causal=read('miki/research/services/causalInvestigationService.ts');
