...
const svcPath = fs.existsSync(path.join(root,'miki/research/services/researchToRemediationService.ts'))
  ? path.join(root,'miki/research/services/researchToRemediationService.ts')
  : path.join(root,'miki/researchToRemediationService.ts');
