...
const checks={type:l.includes('ActionLineage'),field:l.includes('actionLineage: ActionLineage'),action:l.includes('actionId'),knowledge:l.includes('knowledgeIds'),capability:l.includes('capabilityIds'),permission:l.includes('permissionClasses'),outcome:l.includes('outcome: normalized?.status'),backCompat:l.includes('if (!record.actionLineage)')};
console.log(JSON.stringify({version:'v176',checks},null,2));
