import { persistentPersonalityService, failureToleranceKernelService, autonomousQaService, semanticCacheService, softwareFactoryService, dataFactoryService, digitalTwinService } from '../src/services/chapter69_90PlatformServices';
...
const t=digitalTwinService.capture({fidelity:'APPROXIMATE',model:'test-model'}); if(!t.id) throw new Error('chapter82 twin failed');
