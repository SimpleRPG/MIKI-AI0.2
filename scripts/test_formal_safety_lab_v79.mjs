...
const checks=[];
const files=['miki/verification/services/formalSemanticsKernelService.ts','miki/verification/services/faultInjectionLabService.ts','miki/capabilityCompositionProofService.ts','miki/execution/services/executableExplanationService.ts'];
...
const bg=fs.readFileSync(root+'miki/execution/services/backgroundWorkerService.ts','utf8'); checks.push(['fault lab background wired',bg.includes('faultInjectionLabService.run')]);
