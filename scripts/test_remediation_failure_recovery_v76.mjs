...
const remediationPath = fs.existsSync(path.join(root, 'miki/research/services/researchToRemediationService.ts'))
  ? 'miki/research/services/researchToRemediationService.ts'
  : 'miki/researchToRemediationService.ts';
