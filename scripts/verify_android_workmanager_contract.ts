...
const bgWorkerTs = fs.readFileSync(path.join(root, 'miki/execution/services/backgroundWorkerService.ts'), 'utf8');
const nativeWorkManagerTs = fs.readFileSync(path.join(root, 'miki/execution/services/nativeWorkManagerService.ts'), 'utf8');
