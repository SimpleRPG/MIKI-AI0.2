...
const spec=fs.readFileSync(root+'MIKI_AI_18_DOMAIN_DESIGN_PHILOSOPHY.txt','utf8');
const svc=fs.readFileSync(root+'miki/strategy/services/frontierGovernanceService.ts','utf8');
