...
const adapter = fs.existsSync(path.join(root, 'src', 'miki', 'data', 'simpleRpgReferenceService.ts'))
  ? path.join(root, 'src', 'miki', 'data', 'simpleRpgReferenceService.ts')
  : path.join(root, 'src', 'services', 'simpleRpgReferenceService.ts');
const core = fs.existsSync(path.join(root, 'src', 'miki', 'safety', 'services', 'nonLlmCoreService.ts'))
  ? path.join(root, 'src', 'miki', 'safety', 'services', 'nonLlmCoreService.ts')
  : path.join(root, 'src', 'services', 'nonLlmCoreService.ts');
