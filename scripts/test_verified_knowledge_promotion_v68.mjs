...
const files = [
  ...
  fs.existsSync(path.join(root, 'miki/capability/services/capabilityGraphService.ts'))
    ? 'miki/capability/services/capabilityGraphService.ts'
...
const graphFile = fs.existsSync(path.join(root, 'miki/capability/services/capabilityGraphService.ts'))
  ? 'miki/capability/services/capabilityGraphService.ts'
  : 'miki/capabilityGraphService.ts';
const graph = fs.readFileSync(path.join(root, graphFile),'utf8');
