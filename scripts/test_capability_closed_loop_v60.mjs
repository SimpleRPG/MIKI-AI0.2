...
const evolutionPath = [
  path.join(root, 'miki/capability/services/deterministicCapabilityEvolutionService.ts'),
  path.join(root, 'services/deterministicCapabilityEvolutionService.ts'),
].find((p) => fs.existsSync(p));
const orchestratorPath = [
  path.join(root, 'miki/execution/services/taskExecutionOrchestratorService.ts'),
  path.join(root, 'services/taskExecutionOrchestratorService.ts'),
].find((p) => fs.existsSync(p));
