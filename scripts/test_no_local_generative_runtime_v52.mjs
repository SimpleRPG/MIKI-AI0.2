...
if (!fs.existsSync(path.join(root, 'src/miki/safety/services/deterministicRuntimeService.ts')) && !fs.existsSync(path.join(root, 'miki/safety/services/deterministicRuntimeService.ts'))) {
