...
const checks=[];
const a=read('miki/execution/services/automationStudioService.ts');
...
const n=read('miki/research/services/digitalResearchNoteService.ts');
...
const r=read('miki/safety/services/resourceGovernanceService.ts');
...
checks.push(['no local LLM runtime import in v86 services', !read('miki/selfDevelopment/services/mikiSelfCodingSuperchargerService.ts').includes("generationMethod: 'llm_local'" )]);
