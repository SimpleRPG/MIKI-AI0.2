import fs from 'fs';
const utdPath = fs.existsSync('miki/unknown/services/unknownTaskDecompositionService.ts')
  ? 'miki/unknown/services/unknownTaskDecompositionService.ts'
  : 'miki/unknownTaskDecompositionService.ts';
const utd=fs.readFileSync(utdPath,'utf8');
